...
public class SetaScript : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 direccion = RoguePrueba.transform.position - transform.position;
        if (direccion.x >= 0.0f) transform.localScale = new Vector3(-4.0f, 4.0f, 4.0f);
